...
TEST_F(MorphologyFunctionalTest, Erode3x3_8u_C1R_Basic) {
    ...
    NppStatus status = nppiErode3x3_8u_C1R(
        src.get(), src.step(),
        dst.get(), dst.step(),
        roi);
...
TEST_F(MorphologyFunctionalTest, Dilate3x3_8u_C1R_Basic) {
    ...
    NppiSize roi = {width, height};
    NppStatus status = nppiDilate3x3_8u_C1R(
        src.get(), src.step(),
        dst.get(), dst.step(),
        roi);
...
TEST_F(MorphologyFunctionalTest, Erode3x3_32f_C1R_Float) {
    ...
    NppiSize roi = {width, height};
    NppStatus status = nppiErode3x3_32f_C1R(
        src.get(), src.step(),
        dst.get(), dst.step(),
        roi);
...
TEST_F(MorphologyFunctionalTest, Dilate3x3_32f_C1R_Float) {
    ...
    NppiSize roi = {width, height};
    NppStatus status = nppiDilate3x3_32f_C1R(
        src.get(), src.step(),
        dst.get(), dst.step(),
        roi);
