...
TEST_F(SetFunctionalTest, Set_8u_C1R_Ctx_Basic) {
  ...
  // 执行Set操作
  NppStatus status = nppiSet_8u_C1R_Ctx(setValue, dst.get(), dst.step(), oSizeROI, nppStreamCtx);
...
TEST_F(SetFunctionalTest, Set_8u_C3R_Ctx_ColorValues) {
  ...
  // 执行Set操作
  NppStatus status = nppiSet_8u_C3R_Ctx(aValue, dst.get(), dst.step(), oSizeROI, nppStreamCtx);
...
TEST_F(SetFunctionalTest, Set_32f_C1R_Ctx_FloatValue) {
  ...
  // 执行Set操作
  NppStatus status = nppiSet_32f_C1R_Ctx(setValue, dst.get(), dst.step(), oSizeROI, nppStreamCtx);
...
TEST_F(SetFunctionalTest, Set_8u_C1R_Ctx_PartialROI) {
  ...
  NppStatus status = nppiSet_8u_C1R_Ctx(setValue, pDstROI, dst.step(), oSizeROI, nppStreamCtx);
