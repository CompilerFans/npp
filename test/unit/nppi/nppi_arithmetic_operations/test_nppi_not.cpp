...
TEST_F(NppiNotTest, Not_8u_C1R_BasicOperation) {
  ...
  // Create test data
  std::vector<Npp8u> hostSrc = {0x00, 0xFF, 0xAA, 0x55, 0x33, 0xCC, 0x0F, 0xF0,
                                0x3C, 0xC3, 0x69, 0x96, 0x81, 0x7E, 0x42, 0xBD};

  std::vector<Npp8u> expected = {0xFF, 0x00, 0x55, 0xAA, 0xCC, 0x33, 0xF0, 0x0F,
                                 0xC3, 0x3C, 0x96, 0x69, 0x7E, 0x81, 0xBD, 0x42};
