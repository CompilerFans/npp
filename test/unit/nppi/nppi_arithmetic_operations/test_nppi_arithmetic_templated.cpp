...
template <typename T> class NppiArithmeticTemplatedTest : public ::testing::Test {
protected:
  void SetUp() override {
  ...
  template <int Channels> void testBinaryOperation(const std::string &operation, int scaleFactor = 0) {
    // Generate test data
