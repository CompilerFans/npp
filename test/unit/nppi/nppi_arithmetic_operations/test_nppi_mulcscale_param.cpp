...
protected:
  ...
  template <typename T>
  void runMulCScaleTest(T constVal,
      std::function<NppStatus(const T*, int, T, T*, int, NppiSize)> nppC1R,
...
TEST_P(MulCScale8uParamTest, MulCScale_8u) {
  runMulCScaleTest<Npp8u>(static_cast<Npp8u>(128),
      nppiMulCScale_8u_C1R, nppiMulCScale_8u_C1R_Ctx, nppiMulCScale_8u_C1IR, nppiMulCScale_8u_C1IR_Ctx,
      nppiMulCScale_8u_C3R, nppiMulCScale_8u_C3R_Ctx, nppiMulCScale_8u_C3IR, nppiMulCScale_8u_C3IR_Ctx,
      nppiMulCScale_8u_C4R, nppiMulCScale_8u_C4R_Ctx, nppiMulCScale_8u_C4IR, nppiMulCScale_8u_C4IR_Ctx);
}
...
TEST_P(MulCScale16uParamTest, MulCScale_16u) {
  runMulCScaleTest<Npp16u>(static_cast<Npp16u>(32768),
      nppiMulCScale_16u_C1R, nppiMulCScale_16u_C1R_Ctx, nppiMulCScale_16u_C1IR, nppiMulCScale_16u_C1IR_Ctx,
      nppiMulCScale_16u_C3R, nppiMulCScale_16u_C3R_Ctx, nppiMulCScale_16u_C3IR, nppiMulCScale_16u_C3IR_Ctx,
      nppiMulCScale_16u_C4R, nppiMulCScale_16u_C4R_Ctx, nppiMulCScale_16u_C4IR, nppiMulCScale_16u_C4IR_Ctx);
}
