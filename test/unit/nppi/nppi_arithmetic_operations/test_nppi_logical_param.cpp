...
protected:
  ...
  void runBinaryLogicalTest(
      BinaryOp op, std::function<NppStatus(const T *, int, const T *, int, T *, int, NppiSize)> nppC1R,
      ...
      std::function<NppStatus(const T *, int, const T *, int, T *, int, NppiSize, NppStreamContext)> nppAC4R_Ctx =
          nullptr,
    ...
    if (p.in_place) {
      ...
      if (p.is_ac4) {
        status = p.use_ctx
                     ? nppAC4R_Ctx(src1.get(), src1.step(), src2.get(), src2.step(), dst.get(), dst.step(), roi, ctx)
...
TEST_P(And8uLogicalTest, And_8u) {
  ...
  runBinaryLogicalTest<Npp8u>(andOp, nppiAnd_8u_C1R, nppiAnd_8u_C1R_Ctx, nppiAnd_8u_C1IR, nppiAnd_8u_C1IR_Ctx,
                              nppiAnd_8u_C3R, nppiAnd_8u_C3R_Ctx, nppiAnd_8u_C3IR, nppiAnd_8u_C3IR_Ctx, nppiAnd_8u_C4R,
                              nppiAnd_8u_C4R_Ctx, nppiAnd_8u_C4IR, nppiAnd_8u_C4IR_Ctx, nppiAnd_8u_AC4R,
                              nppiAnd_8u_AC4R_Ctx, nppiAnd_8u_AC4IR, nppiAnd_8u_AC4IR_Ctx);
}
...
TEST_P(And16uLogicalTest, And_16u) {
  ...
  runBinaryLogicalTest<Npp16u>(andOp, nppiAnd_16u_C1R, nppiAnd_16u_C1R_Ctx, nppiAnd_16u_C1IR, nppiAnd_16u_C1IR_Ctx,
...
TEST_P(Or8uLogicalTest, Or_8u) {
  ...
  runBinaryLogicalTest<Npp8u>(orOp, nppiOr_8u_C1R, nppiOr_8u_C1R_Ctx, nppiOr_8u_C1IR, nppiOr_8u_C1IR_Ctx, nppiOr_8u_C3R,
                              nppiOr_8u_C3R_Ctx, nppiOr_8u_C3IR, nppiOr_8u_C3IR_Ctx, nppiOr_8u_C4R, nppiOr_8u_C4R_Ctx,
                              nppiOr_8u_C4IR, nppiOr_8u_C4IR_Ctx, nppiOr_8u_AC4R, nppiOr_8u_AC4R_Ctx, nppiOr_8u_AC4IR,
                              nppiOr_8u_AC4IR_Ctx);
}
...
TEST_P(Or16uLogicalTest, Or_16u) {
  ...
  runBinaryLogicalTest<Npp16u>(orOp, nppiOr_16u_C1R, nppiOr_16u_C1R_Ctx, nppiOr_16u_C1IR, nppiOr_16u_C1IR_Ctx,
                               nppiOr_16u_C3R, nppiOr_16u_C3R_Ctx, nppiOr_16u_C3IR, nppiOr_16u_C3IR_Ctx, nppiOr_16u_C4R,
                               nppiOr_16u_C4R_Ctx, nppiOr_16u_C4IR, nppiOr_16u_C4IR_Ctx, nppiOr_16u_AC4R,
                               nppiOr_16u_AC4R_Ctx, nppiOr_16u_AC4IR, nppiOr_16u_AC4IR_Ctx);
}
...
TEST_P(Xor8uLogicalTest, Xor_8u) {
  ...
  runBinaryLogicalTest<Npp8u>(xorOp, nppiXor_8u_C1R, nppiXor_8u_C1R_Ctx, nppiXor_8u_C1IR, nppiXor_8u_C1IR_Ctx,
                              nppiXor_8u_C3R, nppiXor_8u_C3R_Ctx, nppiXor_8u_C3IR, nppiXor_8u_C3IR_Ctx, nppiXor_8u_C4R,
                              nppiXor_8u_C4R_Ctx, nppiXor_8u_C4IR, nppiXor_8u_C4IR_Ctx, nppiXor_8u_AC4R,
                              nppiXor_8u_AC4R_Ctx, nppiXor_8u_AC4IR, nppiXor_8u_AC4IR_Ctx);
}
...
TEST_P(Xor16uLogicalTest, Xor_16u) {
  ...
  runBinaryLogicalTest<Npp16u>(xorOp, nppiXor_16u_C1R, nppiXor_16u_C1R_Ctx, nppiXor_16u_C1IR, nppiXor_16u_C1IR_Ctx,
