...
TEST_P(Div32fcParamTest, Div_32fc) {
  ...
  if (p.in_place) {
    ...
    if (p.channels == 1) {
      status = p.use_ctx ? nppiDiv_32fc_C1R_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, ctx)
                         : nppiDiv_32fc_C1R(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi);
    } else if (p.channels == 3) {
      status = p.use_ctx ? nppiDiv_32fc_C3R_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, ctx)
                         : nppiDiv_32fc_C3R(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi);
    } else if (p.channels == 4) {
      status = p.use_ctx ? nppiDiv_32fc_C4R_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, ctx)
                         : nppiDiv_32fc_C4R(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi);
    } else if (p.channels == -4) {
      status = p.use_ctx ? nppiDiv_32fc_AC4R_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, ctx)
                         : nppiDiv_32fc_AC4R(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi);
    }
    ASSERT_EQ(status, NPP_NO_ERROR);
    std::vector<Npp32fc> result(total);
...
INSTANTIATE_TEST_SUITE_P(Div32fc, Div32fcParamTest, ::testing::Values(
  Div32fcParam{32, 32, 1, false, false, "C1R"},
  Div32fcParam{32, 32, 1, true, false, "C1R_Ctx"},
  Div32fcParam{32, 32, 1, false, true, "C1IR"},
  Div32fcParam{32, 32, 1, true, true, "C1IR_Ctx"},
  Div32fcParam{32, 32, 3, false, false, "C3R"},
  Div32fcParam{32, 32, 3, true, false, "C3R_Ctx"},
  Div32fcParam{32, 32, 3, false, true, "C3IR"},
  Div32fcParam{32, 32, 3, true, true, "C3IR_Ctx"},
  Div32fcParam{32, 32, 4, false, false, "C4R"},
  Div32fcParam{32, 32, 4, true, false, "C4R_Ctx"},
  Div32fcParam{32, 32, 4, false, true, "C4IR"},
  Div32fcParam{32, 32, 4, true, true, "C4IR_Ctx"},
  Div32fcParam{32, 32, -4, false, false, "AC4R"},
  Div32fcParam{32, 32, -4, true, false, "AC4R_Ctx"},
...
TEST_P(Div16scParamTest, Div_16sc) {
  ...
  if (p.in_place) {
    if (p.channels == 1) {
      status = p.use_ctx ? nppiDiv_16sc_C1IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_16sc_C1IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
    } else if (p.channels == 3) {
      status = p.use_ctx ? nppiDiv_16sc_C3IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_16sc_C3IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
    } else if (p.channels == -4) {
      status = p.use_ctx ? nppiDiv_16sc_AC4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_16sc_AC4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
    }
    ASSERT_EQ(status, NPP_NO_ERROR);
    ...
    if (p.channels == -4) d_dst.copyFromHost(src2);
    if (p.channels == 1) {
      status = p.use_ctx ? nppiDiv_16sc_C1RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_16sc_C1RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
    } else if (p.channels == 3) {
      status = p.use_ctx ? nppiDiv_16sc_C3RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_16sc_C3RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
    } else if (p.channels == -4) {
      status = p.use_ctx ? nppiDiv_16sc_AC4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_16sc_AC4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
    }
    ASSERT_EQ(status, NPP_NO_ERROR);
    std::vector<Npp16sc> result(total);
    d_dst.copyToHost(result);
...
INSTANTIATE_TEST_SUITE_P(Div16sc, Div16scParamTest, ::testing::Values(
  Div16scParam{32, 32, 1, 0, false, false, "C1RSfs"},
  Div16scParam{32, 32, 1, 0, true, false, "C1RSfs_Ctx"},
  Div16scParam{32, 32, 1, 0, false, true, "C1IRSfs"},
  Div16scParam{32, 32, 1, 0, true, true, "C1IRSfs_Ctx"},
  Div16scParam{32, 32, 3, 0, false, false, "C3RSfs"},
  Div16scParam{32, 32, 3, 0, true, false, "C3RSfs_Ctx"},
  Div16scParam{32, 32, 3, 0, false, true, "C3IRSfs"},
  Div16scParam{32, 32, 3, 0, true, true, "C3IRSfs_Ctx"},
  Div16scParam{32, 32, -4, 0, false, false, "AC4RSfs"},
  Div16scParam{32, 32, -4, 0, true, false, "AC4RSfs_Ctx"},
  Div16scParam{32, 32, -4, 0, false, true, "AC4IRSfs"},
  Div16scParam{32, 32, -4, 0, true, true, "AC4IRSfs_Ctx"}
...
TEST_P(Div32scParamTest, Div_32sc) {
  ...
  if (p.in_place) {
    if (p.channels == 1) {
      status = p.use_ctx ? nppiDiv_32sc_C1IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_32sc_C1IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
    } else if (p.channels == 3) {
      status = p.use_ctx ? nppiDiv_32sc_C3IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_32sc_C3IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
    } else if (p.channels == -4) {
      status = p.use_ctx ? nppiDiv_32sc_AC4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_32sc_AC4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
    }
    ASSERT_EQ(status, NPP_NO_ERROR);
    ...
    if (p.channels == -4) d_dst.copyFromHost(src2);
    if (p.channels == 1) {
      status = p.use_ctx ? nppiDiv_32sc_C1RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_32sc_C1RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
    } else if (p.channels == 3) {
      status = p.use_ctx ? nppiDiv_32sc_C3RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_32sc_C3RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
    } else if (p.channels == -4) {
      status = p.use_ctx ? nppiDiv_32sc_AC4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                         : nppiDiv_32sc_AC4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
    }
    ASSERT_EQ(status, NPP_NO_ERROR);
    std::vector<Npp32sc> result(total);
    d_dst.copyToHost(result);
...
INSTANTIATE_TEST_SUITE_P(Div32sc, Div32scParamTest, ::testing::Values(
  Div32scParam{32, 32, 1, 0, false, false, "C1RSfs"},
  Div32scParam{32, 32, 1, 0, true, false, "C1RSfs_Ctx"},
  Div32scParam{32, 32, 1, 0, false, true, "C1IRSfs"},
  Div32scParam{32, 32, 1, 0, true, true, "C1IRSfs_Ctx"},
  Div32scParam{32, 32, 3, 0, false, false, "C3RSfs"},
  Div32scParam{32, 32, 3, 0, true, false, "C3RSfs_Ctx"},
  Div32scParam{32, 32, 3, 0, false, true, "C3IRSfs"},
  Div32scParam{32, 32, 3, 0, true, true, "C3IRSfs_Ctx"},
  Div32scParam{32, 32, -4, 0, false, false, "AC4RSfs"},
  Div32scParam{32, 32, -4, 0, true, false, "AC4RSfs_Ctx"},
  Div32scParam{32, 32, -4, 0, false, true, "AC4IRSfs"},
  Div32scParam{32, 32, -4, 0, true, true, "AC4IRSfs_Ctx"}
...
TEST_P(DivIntSfsCompleteParamTest, Div_IntSfs_Complete) {
  ...
  if (p.dtype == "8u") {
    ...
    if (p.in_place) {
      if (p.channels == 3) {
        status = p.use_ctx ? nppiDiv_8u_C3IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_8u_C3IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      } else if (p.channels == 4) {
        status = p.use_ctx ? nppiDiv_8u_C4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_8u_C4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      } else if (p.channels == -4) {
        status = p.use_ctx ? nppiDiv_8u_AC4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_8u_AC4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      ...
      for (int i = 0; i < total; i++) {
        if (p.channels == -4 && (i % 4 == 3)) continue;  // Skip alpha
      ...
      if (p.channels == -4) d_dst.copyFromHost(src2);
      if (p.channels == 3) {
        status = p.use_ctx ? nppiDiv_8u_C3RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_8u_C3RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      } else if (p.channels == 4) {
        status = p.use_ctx ? nppiDiv_8u_C4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_8u_C4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      } else if (p.channels == -4) {
        status = p.use_ctx ? nppiDiv_8u_AC4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_8u_AC4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      std::vector<Npp8u> result(total);
      d_dst.copyToHost(result);
      for (int i = 0; i < total; i++) {
        if (p.channels == -4 && (i % 4 == 3)) continue;
        int expected = src2[i] / src1[i];
        EXPECT_LE(std::abs(static_cast<int>(result[i]) - expected), 1);
      }
    }
    ...
    if (p.in_place) {
      if (p.channels == 4) {
        status = p.use_ctx ? nppiDiv_16u_C4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16u_C4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      } else if (p.channels == -4) {
        status = p.use_ctx ? nppiDiv_16u_AC4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16u_AC4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      ...
      if (p.channels == -4) d_dst.copyFromHost(src2);
      if (p.channels == 4) {
        status = p.use_ctx ? nppiDiv_16u_C4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16u_C4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      } else if (p.channels == -4) {
        status = p.use_ctx ? nppiDiv_16u_AC4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16u_AC4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      std::vector<Npp16u> result(total);
      d_dst.copyToHost(result);
    ...
    if (p.in_place) {
      if (p.channels == 4) {
        status = p.use_ctx ? nppiDiv_16s_C4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16s_C4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      } else if (p.channels == -4) {
        status = p.use_ctx ? nppiDiv_16s_AC4IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16s_AC4IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      ...
      if (p.channels == -4) d_dst.copyFromHost(src2);
      if (p.channels == 4) {
        status = p.use_ctx ? nppiDiv_16s_C4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16s_C4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      } else if (p.channels == -4) {
        status = p.use_ctx ? nppiDiv_16s_AC4RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_16s_AC4RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      std::vector<Npp16s> result(total);
      d_dst.copyToHost(result);
    ...
    if (p.in_place) {
      if (p.channels == 1) {
        status = p.use_ctx ? nppiDiv_32s_C1IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_32s_C1IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      } else if (p.channels == 3) {
        status = p.use_ctx ? nppiDiv_32s_C3IRSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_32s_C3IRSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      ...
      if (p.channels == 1) {
        status = p.use_ctx ? nppiDiv_32s_C1RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_32s_C1RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      } else if (p.channels == 3) {
        status = p.use_ctx ? nppiDiv_32s_C3RSfs_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor, ctx)
                           : nppiDiv_32s_C3RSfs(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, p.scaleFactor);
      }
      ASSERT_EQ(status, NPP_NO_ERROR);
      std::vector<Npp32s> result(total);
      d_dst.copyToHost(result);
...
INSTANTIATE_TEST_SUITE_P(DivIntSfsComplete, DivIntSfsCompleteParamTest, ::testing::Values(
...
TEST_P(Div32fAC4ParamTest, Div_32f_AC4) {
  ...
  if (p.in_place) {
    ...
    status = p.use_ctx ? nppiDiv_32f_AC4R_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi, ctx)
                       : nppiDiv_32f_AC4R(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(), d_dst.get(), d_dst.step(), roi);
    ASSERT_EQ(status, NPP_NO_ERROR);
    std::vector<Npp32f> result(total);
    d_dst.copyToHost(result);
    EXPECT_TRUE(ResultValidator::arraysEqual(result, expected, 1e-4f));
...
INSTANTIATE_TEST_SUITE_P(Div32fAC4, Div32fAC4ParamTest, ::testing::Values(
  Div32fAC4Param{32, 32, true, false, "AC4R_Ctx"},
...
TEST(Div32sC1RTest, Basic) {
  ...
  NppStatus status = nppiDiv_32s_C1R(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(),
...
TEST(Div32sC1RCtxTest, Basic) {
  ...
  NppStatus status = nppiDiv_32s_C1R_Ctx(d_src1.get(), d_src1.step(), d_src2.get(), d_src2.step(),
