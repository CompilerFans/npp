...
INSTANTIATE_TEST_SUITE_P(
    ...
    DivDeviceC_8u_Test,
    ::testing::Values(
        DivDeviceCParam{"8u_C1RSfs", 0, 1, false, true},
        DivDeviceCParam{"8u_C1IRSfs", 0, 1, true, true},
        DivDeviceCParam{"8u_C3RSfs", 0, 3, false, true},
        DivDeviceCParam{"8u_C3IRSfs", 0, 3, true, true},
        DivDeviceCParam{"8u_AC4RSfs", 0, -4, false, true},
        DivDeviceCParam{"8u_AC4IRSfs", 0, -4, true, true},
        DivDeviceCParam{"8u_C4RSfs", 0, 4, false, true},
        DivDeviceCParam{"8u_C4IRSfs", 0, 4, true, true}
    ),
    [](const ::testing::TestParamInfo<DivDeviceCParam>& info) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    DivDeviceC_16u_Test,
    ::testing::Values(
        DivDeviceCParam{"16u_C1RSfs", 1, 1, false, true},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    DivDeviceC_16s_Test,
    ::testing::Values(
        DivDeviceCParam{"16s_C1RSfs", 2, 1, false, true},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    DivDeviceC_32s_Test,
    ::testing::Values(
        DivDeviceCParam{"32s_C1RSfs", 3, 1, false, true},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    DivDeviceC_32f_Test,
    ::testing::Values(
        DivDeviceCParam{"32f_C1R", 5, 1, false, false},
        DivDeviceCParam{"32f_C1IR", 5, 1, true, false},
        DivDeviceCParam{"32f_C3R", 5, 3, false, false},
        DivDeviceCParam{"32f_C3IR", 5, 3, true, false},
        DivDeviceCParam{"32f_AC4R", 5, -4, false, false},
        DivDeviceCParam{"32f_AC4IR", 5, -4, true, false},
        DivDeviceCParam{"32f_C4R", 5, 4, false, false},
