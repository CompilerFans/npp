...
TEST_F(MulC32fInplaceTest, MulC_32f_C3IR_PartialROI) {
  ...
  ASSERT_EQ(nppiMulC_32f_C3IR(aConstants, pRoi, d_srcdst.step(), roi), NPP_NO_ERROR);
...
TEST_F(MulC32fInplaceTest, MulC_32f_C3IR_OddSize_15x15) {
...
TEST_F(MulC32fInplaceTest, MulC_32f_C3IR_CameraSize_640x480) {
