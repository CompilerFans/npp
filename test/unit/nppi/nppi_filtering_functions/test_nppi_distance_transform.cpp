...
TEST_F(NPPIDistanceTransformTest, DistanceTransformAbsPBA_8u16u_C1R_Basic) {
  ...
  status = nppiDistanceTransformAbsPBA_8u16u_C1R_Ctx(d_src, srcStep, 0, 0, // Sites are pixels with value 0
                                                     nullptr, 0,           // No Voronoi output
                                                     nullptr, 0,           // No Voronoi indices
                                                     nullptr, 0,           // No Manhattan distances
                                                     d_transform, transformStep, oSizeROI, d_buffer, nppStreamCtx);
...
TEST_F(NPPIDistanceTransformTest, DistanceTransformPBA_8u32f_C1R_Basic) {
  ...
  // Call distance transform
  status = nppiDistanceTransformPBA_8u32f_C1R_Ctx(d_src, srcStep, 0, 0, // Sites are pixels with value 0
                                                  nullptr, 0,           // No Voronoi output
                                                  nullptr, 0,           // No Voronoi indices
                                                  nullptr, 0,           // No Manhattan distances
                                                  d_transform, transformStep, oSizeROI, d_buffer, nppStreamCtx);
...
TEST_F(NPPIDistanceTransformTest, DistanceTransformPBA_8u64f_C1R_Basic) {
  ...
  // Call distance transform
  status =
      nppiDistanceTransformPBA_8u64f_C1R_Ctx(d_src, srcStep, 0, 0, // Sites are pixels with value 0
                                             nullptr, 0,           // No Voronoi output
                                             nullptr, 0,           // No Voronoi indices
                                             nullptr, 0,           // No Manhattan distances
                                             d_transform, transformStep, oSizeROI, d_buffer, nullptr, nppStreamCtx);
...
TEST_F(NPPIDistanceTransformTest, SignedDistanceTransformPBA_32f64f_C1R_Basic) {
  ...
  status = nppiSignedDistanceTransformPBA_32f64f_C1R_Ctx(d_src, srcStep, 0.0f, // Cutoff value
                                                         0.0, 0.0,             // No sub-pixel shift
                                                         nullptr, 0,           // No Voronoi output
                                                         nullptr, 0,           // No Voronoi indices
                                                         nullptr, 0,           // No Manhattan distances
                                                         d_transform, transformStep, oSizeROI, d_buffer, nullptr,
                                                         nppStreamCtx);
...
TEST_F(NPPIDistanceTransformTest, SignedDistanceTransformPBA_64f_C1R_Basic) {
  ...
  // Call signed distance transform
  status =
      nppiSignedDistanceTransformPBA_64f_C1R_Ctx(d_src, srcStep, 0.0, // Cutoff value
                                                 0.0, 0.0,            // No sub-pixel shift
                                                 nullptr, 0,          // No Voronoi output
                                                 nullptr, 0,          // No Voronoi indices
                                                 nullptr, 0,          // No Manhattan distances
