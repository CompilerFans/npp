 ...
 */
__global__ void magnitude_32fc32f_kernel(const Npp32fc* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void magnitude_sqr_32fc32f_kernel(const Npp32fc* __restrict__ pSrc, int nSrcStep, 
                                             Npp32f* __restrict__ pDst, int nDstStep,
                                             int width, int height)
{
    int x = blockIdx.x * blockDim.x + threadIdx.x;
                                             ...
                                             NppiSize oSizeROI, NppStreamContext nppStreamCtx)
{
    ...
    magnitude_32fc32f_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
                                                ...
                                                NppiSize oSizeROI, NppStreamContext nppStreamCtx)
{
    ...
    magnitude_sqr_32fc32f_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc, nSrcStep, pDst, nDstStep, oSizeROI.width, oSizeROI.height
    );
