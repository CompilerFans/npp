...
extern "C" {
NppStatus nppiThreshold_8u_C1R_Ctx_cuda(const Npp8u* pSrc, int nSrcStep, 
                                       Npp8u* pDst, int nDstStep, 
                                       NppiSize oSizeROI, const Npp8u nThreshold,
                                       NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx);
NppStatus nppiThreshold_8u_C1IR_Ctx_cuda(Npp8u* pSrcDst, int nSrcDstStep, 
                                        NppiSize oSizeROI, const Npp8u nThreshold,
                                        NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx);
NppStatus nppiThreshold_32f_C1R_Ctx_cuda(const Npp32f* pSrc, int nSrcStep, 
                                        Npp32f* pDst, int nDstStep, 
                                        NppiSize oSizeROI, const Npp32f nThreshold,
                                        NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx);
}

// Input validation helper
static inline NppStatus validateThresholdInputs(const void* pSrc, int nSrcStep, 
...
NppStatus nppiThreshold_8u_C1R_Ctx(const Npp8u* pSrc, int nSrcStep,
    ...
    return nppiThreshold_8u_C1R_Ctx_cuda(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                        nThreshold, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiThreshold_8u_C1R(const Npp8u* pSrc, int nSrcStep,
    ...
    return nppiThreshold_8u_C1R_Ctx(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                   nThreshold, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiThreshold_8u_C1IR_Ctx(Npp8u* pSrcDst, int nSrcDstStep,
                                   NppiSize oSizeROI, const Npp8u nThreshold,
                                   NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx) {
    NppStatus status = validateThresholdInputs(pSrcDst, nSrcDstStep, nullptr, 0, oSizeROI, 
                                              eComparisonOperation, true);
    if (status != NPP_SUCCESS) {
        return status;
    }
    
    return nppiThreshold_8u_C1IR_Ctx_cuda(pSrcDst, nSrcDstStep, oSizeROI, 
                                         nThreshold, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiThreshold_8u_C1IR(Npp8u* pSrcDst, int nSrcDstStep,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiThreshold_8u_C1IR_Ctx(pSrcDst, nSrcDstStep, oSizeROI, 
                                    nThreshold, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiThreshold_32f_C1R_Ctx(const Npp32f* pSrc, int nSrcStep,
    ...
    return nppiThreshold_32f_C1R_Ctx_cuda(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                         nThreshold, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiThreshold_32f_C1R(const Npp32f* pSrc, int nSrcStep,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiThreshold_32f_C1R_Ctx(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                    nThreshold, eComparisonOperation, nppStreamCtx);
}