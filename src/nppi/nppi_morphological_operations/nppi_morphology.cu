...
template <typename T>
__device__ inline T erodeGeneral(const T *pSrc, int nSrcStep, int x, int y, int width, int height,
                                const Npp8u *pMask, int maskWidth, int maskHeight, int anchorX, int anchorY) {
...
template <typename T>
__device__ inline T dilateGeneral(const T *pSrc, int nSrcStep, int x, int y, int width, int height,
                                 const Npp8u *pMask, int maskWidth, int maskHeight, int anchorX, int anchorY) {
...
__global__ void nppiErode_8u_C1R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep,
                                        int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
...
__global__ void nppiErode_8u_C4R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep,
                                        int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                        int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiErode_32f_C1R_kernel(const Npp32f *pSrc, int nSrcStep, Npp32f *pDst, int nDstStep,
                                         int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                         int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiErode_32f_C4R_kernel(const Npp32f *pSrc, int nSrcStep, Npp32f *pDst, int nDstStep,
                                         int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                         int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiDilate_8u_C1R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep,
                                         int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                         int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiDilate_8u_C4R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep,
                                         int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                         int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiDilate_32f_C1R_kernel(const Npp32f *pSrc, int nSrcStep, Npp32f *pDst, int nDstStep,
                                          int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                          int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiDilate_32f_C4R_kernel(const Npp32f *pSrc, int nSrcStep, Npp32f *pDst, int nDstStep,
                                          int width, int height, const Npp8u *pMask, int maskWidth, int maskHeight,
                                          int anchorX, int anchorY) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
NppStatus nppiErode_8u_C1R_Ctx_impl(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep, NppiSize oSizeROI,
  ...
  nppiErode_8u_C1R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
    ...
    pMask, oMaskSize.width, oMaskSize.height, oAnchor.x, oAnchor.y);
