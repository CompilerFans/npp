...
static inline NppStatus validateMorphologyInputs(const void* pSrc, int nSrcStep, 
...
NppStatus nppiErode3x3_8u_C1R(const Npp8u* pSrc, Npp32s nSrcStep,
                              Npp8u* pDst, Npp32s nDstStep,
                              NppiSize oSizeROI) {
...
NppStatus nppiDilate3x3_8u_C1R(const Npp8u* pSrc, Npp32s nSrcStep,
                               Npp8u* pDst, Npp32s nDstStep,
                               NppiSize oSizeROI) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
