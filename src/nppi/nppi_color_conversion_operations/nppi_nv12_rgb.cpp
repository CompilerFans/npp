...
extern "C" {
    ...
    cudaError_t nppiNV12ToRGB_8u_ColorTwist32f_P2C3R_kernel(
        const Npp8u* pSrcY, int nSrcYStep,
        const Npp8u* pSrcUV, int nSrcUVStep,
        Npp8u* pDst, int nDstStep,
        NppiSize oSizeROI,
...
NppStatus nppiNV12ToRGB_8u_ColorTwist32f_P2C3R_Ctx(
    const Npp8u * const pSrc[2], int aSrcStep[2],
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI,
    const Npp32f aTwist[3][4],
    NppStreamContext nppStreamCtx)
{
    ...
    // 调用ColorTwist CUDA内核
    cudaError_t cudaStatus = nppiNV12ToRGB_8u_ColorTwist32f_P2C3R_kernel(
        pSrc[0], aSrcStep[0],        // Y plane
 ...
 */
NppStatus nppiNV12ToRGB_8u_ColorTwist32f_P2C3R(
    const Npp8u * const pSrc[2], int aSrcStep[2],
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI,
    const Npp32f aTwist[3][4])
{
    NppStreamContext ctx;
    ctx.hStream = 0;  // 默认流
    return nppiNV12ToRGB_8u_ColorTwist32f_P2C3R_Ctx(pSrc, aSrcStep, pDst, nDstStep, 
                                                    oSizeROI, aTwist, ctx);
}
 ...
 */
NppStatus nppiNV12ToBGR_8u_P2C3R_Ctx(
    const Npp8u * const pSrc[2], int rSrcStep,
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI,
    NppStreamContext nppStreamCtx)
 ...
 */
NppStatus nppiNV12ToBGR_8u_P2C3R(
    const Npp8u * const pSrc[2], int rSrcStep,
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI)
{
 ...
 */
NppStatus nppiNV12ToBGR_709CSC_8u_P2C3R_Ctx(
    const Npp8u * const pSrc[2], int rSrcStep,
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI,
    NppStreamContext nppStreamCtx)
 ...
 */
NppStatus nppiNV12ToBGR_709CSC_8u_P2C3R(
    const Npp8u * const pSrc[2], int rSrcStep,
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI)
{
 ...
 */
NppStatus nppiNV12ToBGR_709HDTV_8u_P2C3R_Ctx(
    const Npp8u * const pSrc[2], int rSrcStep,
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI,
    NppStreamContext nppStreamCtx)
{
    return nppiNV12ToBGR_709CSC_8u_P2C3R_Ctx(pSrc, rSrcStep, pDst, nDstStep, 
                                             oSizeROI, nppStreamCtx);
}
 ...
 */
NppStatus nppiNV12ToBGR_709HDTV_8u_P2C3R(
    const Npp8u * const pSrc[2], int rSrcStep,
    Npp8u * pDst, int nDstStep,
    NppiSize oSizeROI)
{
