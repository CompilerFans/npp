...
cudaError_t nppiBGRToHLS_8u_AC4R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep, NppiSize oSizeROI,
                                        cudaStream_t stream);
cudaError_t nppiBGRToHLS_8u_C3P3R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDstH, Npp8u *pDstL, Npp8u *pDstS,
...
cudaError_t nppiBGRToHLS_8u_P3R_kernel(const Npp8u *pSrcB, int nSrcStep, const Npp8u *pSrcG, const Npp8u *pSrcR,
                                       ...
                                       cudaStream_t stream);
cudaError_t nppiBGRToHLS_8u_AC4P4R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDstH, Npp8u *pDstL, Npp8u *pDstS,
...
cudaError_t nppiBGRToHLS_8u_AP4R_kernel(const Npp8u *pSrcB, int nSrcStep, const Npp8u *pSrcG, const Npp8u *pSrcR,
                                        ...
                                        int nDstStep, NppiSize oSizeROI, cudaStream_t stream);
cudaError_t nppiHLSToBGR_8u_C3P3R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDstB, Npp8u *pDstG, Npp8u *pDstR,
                                         int nDstStep, NppiSize oSizeROI, cudaStream_t stream);
...
cudaError_t nppiHLSToBGR_8u_P3R_kernel(const Npp8u *pSrcH, int nSrcStep, const Npp8u *pSrcL, const Npp8u *pSrcS,
                                       ...
                                       cudaStream_t stream);
cudaError_t nppiHLSToBGR_8u_AC4P4R_kernel(const Npp8u *pSrc, int nSrcStep, Npp8u *pDstB, Npp8u *pDstG, Npp8u *pDstR,
                                          Npp8u *pDstA, int nDstStep, NppiSize oSizeROI, cudaStream_t stream);
...
NppStatus nppiRGBToHLS_8u_AC4R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep, NppiSize oSizeROI,
  ...
  cudaError_t cudaStatus = nppiRGBToHLS_8u_AC4R_kernel(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiHLSToRGB_8u_AC4R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep, NppiSize oSizeROI,
  ...
  cudaError_t cudaStatus = nppiHLSToRGB_8u_AC4R_kernel(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiBGRToHLS_8u_AC4R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst, int nDstStep, NppiSize oSizeROI,
  ...
  cudaError_t cudaStatus = nppiBGRToHLS_8u_AC4R_kernel(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiBGRToHLS_8u_C3P3R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst[3], int nDstStep, NppiSize oSizeROI,
                                    NppStreamContext nppStreamCtx) {
  ...
  cudaError_t cudaStatus =
      nppiBGRToHLS_8u_C3P3R_kernel(pSrc, nSrcStep, pDst[0], pDst[1], pDst[2], nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiBGRToHLS_8u_P3C3R_Ctx(const Npp8u *const pSrc[3], int nSrcStep, Npp8u *pDst, int nDstStep,
  ...
  cudaError_t cudaStatus =
      nppiBGRToHLS_8u_P3C3R_kernel(pSrc[0], nSrcStep, pSrc[1], pSrc[2], pDst, nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiBGRToHLS_8u_P3R_Ctx(const Npp8u *const pSrc[3], int nSrcStep, Npp8u *pDst[3], int nDstStep,
  ...
  cudaError_t cudaStatus = nppiBGRToHLS_8u_P3R_kernel(pSrc[0], nSrcStep, pSrc[1], pSrc[2], pDst[0], pDst[1], pDst[2],
...
NppStatus nppiBGRToHLS_8u_AC4P4R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst[4], int nDstStep, NppiSize oSizeROI,
                                     NppStreamContext nppStreamCtx) {
  ...
  cudaError_t cudaStatus = nppiBGRToHLS_8u_AC4P4R_kernel(pSrc, nSrcStep, pDst[0], pDst[1], pDst[2], pDst[3], nDstStep,
...
NppStatus nppiHLSToBGR_8u_C3P3R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst[3], int nDstStep, NppiSize oSizeROI,
                                    NppStreamContext nppStreamCtx) {
  NppStatus status = validatePackedToPlanarInput(pSrc, nSrcStep, pDst, nDstStep, 3, oSizeROI, 3);
  if (status != NPP_SUCCESS) {
    return status;
  ...
  cudaError_t cudaStatus =
      nppiHLSToBGR_8u_C3P3R_kernel(pSrc, nSrcStep, pDst[0], pDst[1], pDst[2], nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiHLSToBGR_8u_P3C3R_Ctx(const Npp8u *const pSrc[3], int nSrcStep, Npp8u *pDst, int nDstStep,
  ...
  cudaError_t cudaStatus =
      nppiHLSToBGR_8u_P3C3R_kernel(pSrc[0], nSrcStep, pSrc[1], pSrc[2], pDst, nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiHLSToBGR_8u_P3R_Ctx(const Npp8u *const pSrc[3], int nSrcStep, Npp8u *pDst[3], int nDstStep,
  ...
  cudaError_t cudaStatus = nppiHLSToBGR_8u_P3R_kernel(pSrc[0], nSrcStep, pSrc[1], pSrc[2], pDst[0], pDst[1], pDst[2],
                                                      nDstStep, oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
...
NppStatus nppiHLSToBGR_8u_AC4P4R_Ctx(const Npp8u *pSrc, int nSrcStep, Npp8u *pDst[4], int nDstStep, NppiSize oSizeROI,
                                     NppStreamContext nppStreamCtx) {
  NppStatus status = validatePackedToPlanarInput(pSrc, nSrcStep, pDst, nDstStep, 4, oSizeROI, 4);
  if (status != NPP_SUCCESS) {
    return status;
  ...
  cudaError_t cudaStatus = nppiHLSToBGR_8u_AC4P4R_kernel(pSrc, nSrcStep, pDst[0], pDst[1], pDst[2], pDst[3], nDstStep,
                                                         oSizeROI, nppStreamCtx.hStream);
  return (cudaStatus == cudaSuccess) ? NPP_SUCCESS : NPP_CUDA_KERNEL_EXECUTION_ERROR;
}
