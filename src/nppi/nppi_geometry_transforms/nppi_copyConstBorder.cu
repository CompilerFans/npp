...
__global__ void nppiCopyConstBorder_8u_C1R_kernel(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSizeROI,
    ...
    if (x < oDstSizeROI.width && y < oDstSizeROI.height) {
        ...
        if (x >= nLeftBorderWidth && x < nLeftBorderWidth + oSrcSizeROI.width &&
            y >= nTopBorderHeight && y < nTopBorderHeight + oSrcSizeROI.height) {
            // Copy from source
...
__global__ void nppiCopyConstBorder_8u_C3R_kernel(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSizeROI,
                                                  Npp8u* pDst, int nDstStep, NppiSize oDstSizeROI,
...
__global__ void nppiCopyConstBorder_16s_C1R_kernel(const Npp16s* pSrc, int nSrcStep, NppiSize oSrcSizeROI,
...
__global__ void nppiCopyConstBorder_32f_C1R_kernel(const Npp32f* pSrc, int nSrcStep, NppiSize oSrcSizeROI,
...
NppStatus nppiCopyConstBorder_8u_C1R_Ctx_cuda(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSizeROI,
    ...
    nppiCopyConstBorder_8u_C1R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc, nSrcStep, oSrcSizeROI, pDst, nDstStep, oDstSizeROI,
...
NppStatus nppiCopyConstBorder_8u_C3R_Ctx_cuda(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSizeROI,
    ...
    nppiCopyConstBorder_8u_C3R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc, nSrcStep, oSrcSizeROI, pDst, nDstStep, oDstSizeROI,
        nTopBorderHeight, nLeftBorderWidth, d_aValue);
