...
static inline NppStatus validateRemapPlanarInputs(const void *const *pSrc, NppiSize oSrcSize, int nSrcStep,
                                                  NppiRect oSrcROI, const void *pXMap, int nXMapStep, const void *pYMap,
                                                  int nYMapStep, void **pDst, int nDstStep, NppiSize oDstSizeROI,
                                                  int eInterpolation, int planes) {
  if (!pSrc || !pDst) {
    return NPP_NULL_POINTER_ERROR;
  }
...
NppStatus nppiRemap_8u_AC4R(const Npp8u *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                            int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp8u *pDst, int nDstStep,
                            NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_8u_P3R_Ctx(const Npp8u *const pSrc[3], NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
  ...
  NppStatus status = validateRemapPlanarInputs(reinterpret_cast<const void *const *>(pSrc), oSrcSize, nSrcStep, oSrcROI,
                                               pXMap, nXMapStep, pYMap, nYMapStep, reinterpret_cast<void **>(pDst),
                                               nDstStep, oDstSizeROI, eInterpolation, 3);
  if (status != NPP_SUCCESS) {
    return status;
  }
...
NppStatus nppiRemap_8u_P4R_Ctx(const Npp8u *const pSrc[4], NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
  ...
  NppStatus status = validateRemapPlanarInputs(reinterpret_cast<const void *const *>(pSrc), oSrcSize, nSrcStep, oSrcROI,
                                               pXMap, nXMapStep, pYMap, nYMapStep, reinterpret_cast<void **>(pDst),
                                               nDstStep, oDstSizeROI, eInterpolation, 4);
  if (status != NPP_SUCCESS) {
    return status;
  }
...
NppStatus nppiRemap_16u_C4R(const Npp16u *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                            int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp16u *pDst, int nDstStep,
                            NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_16u_AC4R(const Npp16u *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                             int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp16u *pDst, int nDstStep,
                             NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_16s_C4R(const Npp16s *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                            int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp16s *pDst, int nDstStep,
                            NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_16s_AC4R(const Npp16s *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                             int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp16s *pDst, int nDstStep,
                             NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_32f_C4R(const Npp32f *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                            int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp32f *pDst, int nDstStep,
                            NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_32f_AC4R(const Npp32f *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp32f *pXMap,
                             int nXMapStep, const Npp32f *pYMap, int nYMapStep, Npp32f *pDst, int nDstStep,
                             NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_64f_C4R(const Npp64f *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp64f *pXMap,
                            int nXMapStep, const Npp64f *pYMap, int nYMapStep, Npp64f *pDst, int nDstStep,
                            NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiRemap_64f_AC4R(const Npp64f *pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI, const Npp64f *pXMap,
                             int nXMapStep, const Npp64f *pYMap, int nYMapStep, Npp64f *pDst, int nDstStep,
                             NppiSize oDstSizeROI, int eInterpolation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
