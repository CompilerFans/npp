 ...
 */
static inline NppStatus validateWarpPerspectiveInputs(const void* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
...
NppStatus nppiWarpPerspective_8u_C1R_Ctx(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
                                          ...
                                          const double aCoeffs[3][3], int eInterpolation, 
                                          NppStreamContext nppStreamCtx) {
    NppStatus status = validateWarpPerspectiveInputs(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation);
    if (status != NPP_SUCCESS) {
        return status;
    }
    
    return nppiWarpPerspective_8u_C1R_Ctx_cuda(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpPerspective_8u_C1R(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    return nppiWarpPerspective_8u_C1R_Ctx(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpPerspective_8u_C3R_Ctx(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    return nppiWarpPerspective_8u_C3R_Ctx_cuda(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpPerspective_8u_C3R(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiWarpPerspective_8u_C3R_Ctx(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpPerspective_32f_C1R_Ctx(const Npp32f* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    return nppiWarpPerspective_32f_C1R_Ctx_cuda(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpPerspective_32f_C1R(const Npp32f* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiWarpPerspective_32f_C1R_Ctx(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}