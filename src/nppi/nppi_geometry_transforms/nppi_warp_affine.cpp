 ...
 */
NppStatus nppiWarpAffine_8u_C1R_Ctx(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
                                     Npp8u* pDst, int nDstStep, NppiRect oDstROI,
                                     const double aCoeffs[2][3], int eInterpolation, 
                                     NppStreamContext nppStreamCtx) {
    NppStatus status = validateWarpAffineInputs(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation);
    if (status != NPP_SUCCESS) {
        return status;
    }
    
    return nppiWarpAffine_8u_C1R_Ctx_cuda(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpAffine_8u_C1R(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    return nppiWarpAffine_8u_C1R_Ctx(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}

/**
 * 8-bit unsigned three channel affine warp
 */
NppStatus nppiWarpAffine_8u_C3R_Ctx(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
                                     Npp8u* pDst, int nDstStep, NppiRect oDstROI,
                                     const double aCoeffs[2][3], int eInterpolation, 
                                     NppStreamContext nppStreamCtx) {
    NppStatus status = validateWarpAffineInputs(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation);
    ...
    return nppiWarpAffine_8u_C3R_Ctx_cuda(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpAffine_8u_C3R(const Npp8u* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiWarpAffine_8u_C3R_Ctx(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpAffine_32f_C1R_Ctx(const Npp32f* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    return nppiWarpAffine_32f_C1R_Ctx_cuda(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}
...
NppStatus nppiWarpAffine_32f_C1R(const Npp32f* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiWarpAffine_32f_C1R_Ctx(pSrc, oSrcSize, nSrcStep, oSrcROI, pDst, nDstStep, oDstROI, aCoeffs, eInterpolation, nppStreamCtx);
}