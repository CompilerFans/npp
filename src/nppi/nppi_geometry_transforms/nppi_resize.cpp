...
static inline NppStatus validateResizeInputs(const void* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
    ...
    if (oDstRectROI.x < 0 || oDstRectROI.y < 0 || 
        oDstRectROI.x + oDstRectROI.width > oDstSize.width ||
...
NppStatus nppiResize_8u_C1R_Ctx(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
                                Npp8u* pDst, int nDstStep, NppiSize oDstSize, NppiRect oDstRectROI,
                                int eInterpolation, NppStreamContext nppStreamCtx) {
    ...
    return nppiResize_8u_C1R_Ctx_cuda(pSrc, nSrcStep, oSrcSize, oSrcRectROI,
                                     pDst, nDstStep, oDstSize, oDstRectROI,
                                     eInterpolation, nppStreamCtx);
}

NppStatus nppiResize_8u_C1R(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
                           Npp8u* pDst, int nDstStep, NppiSize oDstSize, NppiRect oDstRectROI,
                           int eInterpolation) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiResize_8u_C1R_Ctx(pSrc, nSrcStep, oSrcSize, oSrcRectROI,
                                pDst, nDstStep, oDstSize, oDstRectROI,
                                eInterpolation, nppStreamCtx);
}

// 8-bit unsigned three channel resize
NppStatus nppiResize_8u_C3R_Ctx(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
                                Npp8u* pDst, int nDstStep, NppiSize oDstSize, NppiRect oDstRectROI,
                                int eInterpolation, NppStreamContext nppStreamCtx) {
    NppStatus status = validateResizeInputs(pSrc, nSrcStep, oSrcSize, oSrcRectROI,
                                           pDst, nDstStep, oDstSize, oDstRectROI, eInterpolation);
    ...
    return nppiResize_8u_C3R_Ctx_cuda(pSrc, nSrcStep, oSrcSize, oSrcRectROI,
                                     pDst, nDstStep, oDstSize, oDstRectROI,
                                     eInterpolation, nppStreamCtx);
}
