...
__global__ void nppiResize_8u_C1R_nearest_kernel(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
...
__global__ void nppiResize_8u_C1R_linear_kernel(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
                                               Npp8u* pDst, int nDstStep, NppiSize oDstSize, NppiRect oDstRectROI) {
    int dx = blockIdx.x * blockDim.x + threadIdx.x;
    int dy = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiResize_8u_C3R_nearest_kernel(const Npp8u* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
                                                 Npp8u* pDst, int nDstStep, NppiSize oDstSize, NppiRect oDstRectROI) {
    int dx = blockIdx.x * blockDim.x + threadIdx.x;
    int dy = blockIdx.y * blockDim.y + threadIdx.y;
...
__global__ void nppiResize_32f_C3R_linear_kernel(const Npp32f* pSrc, int nSrcStep, NppiSize oSrcSize, NppiRect oSrcRectROI,
