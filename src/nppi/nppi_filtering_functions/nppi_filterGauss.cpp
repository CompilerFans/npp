...
static inline NppStatus validateFilterGaussInputs(const void* pSrc, int nSrcStep, 
    ...
    if (eMaskSize != NPP_MASK_SIZE_3_X_3 && 
        eMaskSize != NPP_MASK_SIZE_5_X_5 && 
        eMaskSize != NPP_MASK_SIZE_7_X_7) {
...
NppStatus nppiFilterGauss_8u_C1R_Ctx(const Npp8u* pSrc, Npp32s nSrcStep,
...
NppStatus nppiFilterGauss_8u_C1R(const Npp8u* pSrc, Npp32s nSrcStep,
    ...
    return nppiFilterGauss_8u_C1R_Ctx(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                     eMaskSize, nppStreamCtx);
}

// 8-bit unsigned three channel Gaussian filter
NppStatus nppiFilterGauss_8u_C3R_Ctx(const Npp8u* pSrc, Npp32s nSrcStep,
                                     Npp8u* pDst, Npp32s nDstStep,
                                     NppiSize oSizeROI, NppiMaskSize eMaskSize, 
                                     NppStreamContext nppStreamCtx) {
    NppStatus status = validateFilterGaussInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, eMaskSize);
...
NppStatus nppiFilterGauss_8u_C3R(const Npp8u* pSrc, Npp32s nSrcStep,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiFilterGauss_8u_C3R_Ctx(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                     eMaskSize, nppStreamCtx);
}

// 32-bit float single channel Gaussian filter
NppStatus nppiFilterGauss_32f_C1R_Ctx(const Npp32f* pSrc, Npp32s nSrcStep,
...
NppStatus nppiFilterGauss_32f_C1R(const Npp32f* pSrc, Npp32s nSrcStep,
    ...
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiFilterGauss_32f_C1R_Ctx(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, 
                                      eMaskSize, nppStreamCtx);
}