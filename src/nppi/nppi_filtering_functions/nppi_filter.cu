...
__global__ void nppiFilter_8u_C1R_kernel(const Npp8u* pSrc, int nSrcStep,
                                         Npp8u* pDst, int nDstStep,
                                         int width, int height,
                                         const Npp32s* pKernel, int kernelWidth, int kernelHeight,
...
__global__ void nppiFilter_8u_C3R_kernel(const Npp8u* pSrc, int nSrcStep,
                                         Npp8u* pDst, int nDstStep,
                                         int width, int height,
                                         const Npp32s* pKernel, int kernelWidth, int kernelHeight,
                                         int anchorX, int anchorY, Npp32s nDivisor) {
...
__global__ void nppiFilter_32f_C1R_kernel(const Npp32f* pSrc, int nSrcStep,
                                          Npp32f* pDst, int nDstStep,
                                          int width, int height,
                                          const Npp32f* pKernel, int kernelWidth, int kernelHeight,
...
NppStatus nppiFilter_8u_C1R_Ctx_cuda(const Npp8u* pSrc, int nSrcStep,
    ...
    nppiFilter_8u_C1R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        ...
        d_kernel, oKernelSize.width, oKernelSize.height,
