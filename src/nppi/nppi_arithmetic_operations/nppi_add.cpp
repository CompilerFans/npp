...
/**
 * NPP Image Add Functions Implementation
 * Implements nppiAdd functions for various data types
 * (Two source images addition)
 */
                                ...
                                NppStreamContext nppStreamCtx)
{
    ...
    return nppiAdd_8u_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
...
NppStatus nppiAdd_8u_C1IRSfs(const Npp8u * pSrc, int nSrcStep, 
                             Npp8u * pSrcDst, int nSrcDstStep, 
                             NppiSize oSizeROI, int nScaleFactor)
{
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiAdd_8u_C1IRSfs_Ctx(pSrc, nSrcStep, pSrcDst, nSrcDstStep, 
                                  oSizeROI, nScaleFactor, nppStreamCtx);
}
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiAdd_16u_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                              ...
                              NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiAdd_32f_C1R_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
                           ...
                           NppiSize oSizeROI)
{
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiAdd_32f_C1IR_Ctx(pSrc, nSrcStep, pSrcDst, nSrcDstStep, 
                                oSizeROI, nppStreamCtx);
}
                                ...
                                NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiAdd_8u_C3RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                              ...
                              NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiAdd_32f_C3R_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nppStreamCtx);
}
