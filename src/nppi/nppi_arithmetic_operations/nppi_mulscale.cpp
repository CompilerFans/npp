 ...
 */
NppStatus nppiMulScale_8u_C1R_Ctx(const Npp8u* pSrc1, int nSrc1Step, const Npp8u* pSrc2, int nSrc2Step,
                                  Npp8u* pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx) {
...
NppStatus nppiMulScale_8u_C1R(const Npp8u* pSrc1, int nSrc1Step, const Npp8u* pSrc2, int nSrc2Step,
 ...
 */
NppStatus nppiMulScale_8u_C1IR_Ctx(const Npp8u* pSrc, int nSrcStep, Npp8u* pSrcDst, int nSrcDstStep,
    ...
    return nppiMulScale_8u_C1R_Ctx_cuda(pSrc, nSrcStep, pSrcDst, nSrcDstStep, pSrcDst, nSrcDstStep, oSizeROI, nppStreamCtx);
}
 ...
 */
NppStatus nppiMulScale_16u_C1R_Ctx(const Npp16u* pSrc1, int nSrc1Step, const Npp16u* pSrc2, int nSrc2Step,
                                   Npp16u* pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx) {
    NppStatus status = validateMulScaleInputs(pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
...
NppStatus nppiMulScale_16u_C1R(const Npp16u* pSrc1, int nSrc1Step, const Npp16u* pSrc2, int nSrc2Step,
...
NppStatus nppiMulScale_16u_C1IR_Ctx(const Npp16u* pSrc, int nSrcStep, Npp16u* pSrcDst, int nSrcDstStep,
    ...
    return nppiMulScale_16u_C1R_Ctx_cuda(pSrc, nSrcStep, pSrcDst, nSrcDstStep, pSrcDst, nSrcDstStep, oSizeROI, nppStreamCtx);
}
