 ...
 */
__global__ void divC_8u_C1RSfs_kernel(const Npp8u* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void divC_16u_C1RSfs_kernel(const Npp16u* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void divC_16s_C1RSfs_kernel(const Npp16s* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void divC_32f_C1R_kernel(const Npp32f* __restrict__ pSrc, int nSrcStep, 
                                    ...
                                    NppStreamContext nppStreamCtx)
{
    ...
    // Launch kernel with the specified CUDA stream
    divC_32f_C1R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, nConstant, pDst, nDstStep, 
