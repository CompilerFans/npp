...
/**
 * CUDA Kernels for NPP Image Mul Functions
 */
...
__global__ void nppiMul_8u_C1RSfs_kernel(
...
__global__ void nppiMul_8u_C3RSfs_kernel(
    const Npp8u* pSrc1, int nSrc1Step,
    const Npp8u* pSrc2, int nSrc2Step,
    Npp8u* pDst, int nDstStep,
    int width, int height, int nScaleFactor)
...
__global__ void nppiMul_16u_C1RSfs_kernel(
...
__global__ void nppiMul_16s_C1RSfs_kernel(
...
__global__ void nppiMul_32f_C1R_kernel(
...
__global__ void nppiMul_32f_C3R_kernel(
    const Npp32f* pSrc1, int nSrc1Step,
    const Npp32f* pSrc2, int nSrc2Step,
    Npp32f* pDst, int nDstStep,
    int width, int height)
    ...
    NppStreamContext nppStreamCtx)
{
    ...
    nppiMul_8u_C1RSfs_kernel<<<grid, block, 0, nppStreamCtx.hStream>>>(
    ...
    NppStreamContext nppStreamCtx)
{
    ...
    nppiMul_8u_C3RSfs_kernel<<<grid, block, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep,
        oSizeROI.width, oSizeROI.height, nScaleFactor);
    ...
    NppStreamContext nppStreamCtx)
{
    ...
    nppiMul_32f_C1R_kernel<<<grid, block, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep,
    ...
    NppStreamContext nppStreamCtx)
{
    ...
    nppiMul_32f_C3R_kernel<<<grid, block, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep,
        oSizeROI.width, oSizeROI.height);
