 ...
 */
__global__ void subC_8u_C1RSfs_kernel(const Npp8u* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void subC_16u_C1RSfs_kernel(const Npp16u* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void subC_16s_C1RSfs_kernel(const Npp16s* __restrict__ pSrc, int nSrcStep, 
 ...
 */
__global__ void subC_32f_C1R_kernel(const Npp32f* __restrict__ pSrc, int nSrcStep, 
...
/**
 * CUDA implementation of nppiSubC_8u_C1RSfs_Ctx
 */
...
/**
 * CUDA implementation of nppiSubC_16u_C1RSfs_Ctx
 */
...
/**
 * CUDA implementation of nppiSubC_16s_C1RSfs_Ctx
 */
...
/**
 * CUDA implementation of nppiSubC_32f_C1R_Ctx
 */
                                    ...
                                    NppStreamContext nppStreamCtx)
{
    ...
    // Launch kernel with the specified CUDA stream
    subC_32f_C1R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, nConstant, pDst, nDstStep, 
 ...
 */
__global__ void subC_32s_C1RSfs_kernel(const Npp32s* __restrict__ pSrc, int nSrcStep, 
                                       Npp32s nConstant, Npp32s* __restrict__ pDst, 
                                       int nDstStep, int width, int height, int nScaleFactor)
{
    int x = blockIdx.x * blockDim.x + threadIdx.x;
    int y = blockIdx.y * blockDim.y + threadIdx.y;
    ...
    const Npp32s* srcPixel = reinterpret_cast<const Npp32s*>(
        reinterpret_cast<const char*>(pSrc) + y * nSrcStep) + x;
    Npp32s* dstPixel = reinterpret_cast<Npp32s*>(
        reinterpret_cast<char*>(pDst) + y * nDstStep) + x;
...
__global__ void subC_16u_C3RSfs_kernel(const Npp16u* __restrict__ pSrc, int nSrcStep,
                                       const Npp16u* __restrict__ aConstants,
                                       Npp16u* __restrict__ pDst, int nDstStep,
                                       int width, int height, int nScaleFactor)
{
    int x = blockIdx.x * blockDim.x + threadIdx.x;
    int y = blockIdx.y * blockDim.y + threadIdx.y;
    ...
    const Npp16u* srcPixel = reinterpret_cast<const Npp16u*>(
        reinterpret_cast<const char*>(pSrc) + y * nSrcStep) + x * 3;
    Npp16u* dstPixel = reinterpret_cast<Npp16u*>(
        reinterpret_cast<char*>(pDst) + y * nDstStep) + x * 3;
...
__global__ void subC_32f_C3R_kernel(const Npp32f* __restrict__ pSrc, int nSrcStep,
                                    const Npp32f* __restrict__ aConstants,
                                    ...
                                    int width, int height)
{
    ...
    const Npp32f* srcPixel = reinterpret_cast<const Npp32f*>(
        reinterpret_cast<const char*>(pSrc) + y * nSrcStep) + x * 3;
    Npp32f* dstPixel = reinterpret_cast<Npp32f*>(
        reinterpret_cast<char*>(pDst) + y * nDstStep) + x * 3;
 ...
 */
__global__ void subC_8u_C1IRSfs_kernel(Npp8u nConstant, Npp8u* __restrict__ pSrcDst,
                                       int nSrcDstStep, int width, int height, int nScaleFactor)
{
    int x = blockIdx.x * blockDim.x + threadIdx.x;
    int y = blockIdx.y * blockDim.y + threadIdx.y;
                                      ...
                                      NppStreamContext nppStreamCtx)
{
    ...
    cudaMemcpyAsync(d_constants, aConstants, 3 * sizeof(Npp8u), 
                                       ...
                                       NppStreamContext nppStreamCtx)
{
    ...
    cudaMemcpyAsync(d_constants, aConstants, 3 * sizeof(Npp16u), 
                    cudaMemcpyHostToDevice, nppStreamCtx.hStream);
                                    ...
                                    NppStreamContext nppStreamCtx)
{
    ...
    cudaMemcpyAsync(d_constants, aConstants, 3 * sizeof(Npp32f), 
                    cudaMemcpyHostToDevice, nppStreamCtx.hStream);
    ...
    subC_32f_C3R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, d_constants, pDst, nDstStep,
        oSizeROI.width, oSizeROI.height
    );
                                      ...
                                      NppStreamContext nppStreamCtx)
{
    ...
    cudaMemcpyAsync(d_constants, aConstants, 4 * sizeof(Npp8u), 
                    cudaMemcpyHostToDevice, nppStreamCtx.hStream);
