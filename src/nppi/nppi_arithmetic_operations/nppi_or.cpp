...
NppStatus nppiOr_8u_C1R_Ctx(const Npp8u * pSrc1, int nSrc1Step, 
    ...
    // 调用CUDA内核
    cudaError_t cudaStatus = nppiOr_8u_C1R_kernel(pSrc1, nSrc1Step, pSrc2, nSrc2Step,
...
NppStatus nppiOrC_8u_C1R_Ctx(const Npp8u * pSrc, int nSrcStep, 
    ...
    // 调用CUDA内核
    cudaError_t cudaStatus = nppiOrC_8u_C1R_kernel(pSrc, nSrcStep, nConstant,
                                                   pDst, nDstStep, oSizeROI,
                                                   nppStreamCtx.hStream);
...
NppStatus nppiOrC_8u_C1R(const Npp8u * pSrc, int nSrcStep, 
    ...
    NppStreamContext ctx;
    ctx.hStream = 0;  // 默认流
    return nppiOrC_8u_C1R_Ctx(pSrc, nSrcStep, nConstant,
                              pDst, nDstStep, oSizeROI, ctx);
}