...
NppStatus nppiMulScale_8u_C1R_Ctx_impl(const Npp8u *pSrc1, int nSrc1Step, const Npp8u *pSrc2, int nSrc2Step,
  ...
  return BinaryOperationExecutor<Npp8u, 1, MulScaleOp<Npp8u>>::execute(pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst,
...
NppStatus nppiMulScale_16u_C1R_Ctx_impl(const Npp16u *pSrc1, int nSrc1Step, const Npp16u *pSrc2, int nSrc2Step,
  ...
  return BinaryOperationExecutor<Npp16u, 1, MulScaleOp<Npp16u>>::execute(pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst,
                                                                         nDstStep, oSizeROI, 0, nppStreamCtx.hStream);
}
