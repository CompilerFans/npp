...
NppStatus nppiCompareC_8u_C1R_Ctx(const Npp8u *pSrc, int nSrcStep, const Npp8u nConstant, Npp8u *pDst, int nDstStep,
...
NppStatus nppiCompareC_8u_C1R(const Npp8u *pSrc, int nSrcStep, const Npp8u nConstant, Npp8u *pDst, int nDstStep,
                              NppiSize oSizeROI, NppCmpOp eComparisonOperation) {
  NppStreamContext nppStreamCtx;
...
NppStatus nppiCompareC_16s_C1R_Ctx(const Npp16s *pSrc, int nSrcStep, const Npp16s nConstant, Npp8u *pDst, int nDstStep,
                                   NppiSize oSizeROI, NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx) {
  NppStatus status = validateCompareCInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, eComparisonOperation);
  if (status != NPP_SUCCESS) {
    return status;
...
NppStatus nppiCompareC_16s_C1R(const Npp16s *pSrc, int nSrcStep, const Npp16s nConstant, Npp8u *pDst, int nDstStep,
                               NppiSize oSizeROI, NppCmpOp eComparisonOperation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
...
NppStatus nppiCompareC_32f_C1R_Ctx(const Npp32f *pSrc, int nSrcStep, const Npp32f nConstant, Npp8u *pDst, int nDstStep,
                                   NppiSize oSizeROI, NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx) {
  NppStatus status = validateCompareCInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, eComparisonOperation);
  if (status != NPP_SUCCESS) {
    return status;
...
NppStatus nppiCompareC_32f_C1R(const Npp32f *pSrc, int nSrcStep, const Npp32f nConstant, Npp8u *pDst, int nDstStep,
                               NppiSize oSizeROI, NppCmpOp eComparisonOperation) {
  NppStreamContext nppStreamCtx;
  nppStreamCtx.hStream = 0;
