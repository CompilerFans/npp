...
NppStatus nppiCompareC_8u_C1R_Ctx_impl(const Npp8u *pSrc, int nSrcStep, 
    ...
    return CompareOperationExecutor<Npp8u, 1, CompareConstOp<Npp8u>>::execute(
        pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx.hStream, op);
}

// 16s C1 comparison operations  
NppStatus nppiCompareC_16s_C1R_Ctx_impl(const Npp16s *pSrc, int nSrcStep, 
                                         Npp16s nConstant, Npp8u *pDst, int nDstStep,
                                         NppiSize oSizeROI, NppCmpOp eComparisonOperation,
                                         NppStreamContext nppStreamCtx) {
    CompareConstOp<Npp16s> op(nConstant, eComparisonOperation);
    return CompareOperationExecutor<Npp16s, 1, CompareConstOp<Npp16s>>::execute(
        pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx.hStream, op);
}

// 32f C1 comparison operations
NppStatus nppiCompareC_32f_C1R_Ctx_impl(const Npp32f *pSrc, int nSrcStep, 
                                         Npp32f nConstant, Npp8u *pDst, int nDstStep,
                                         NppiSize oSizeROI, NppCmpOp eComparisonOperation,
                                         NppStreamContext nppStreamCtx) {
    CompareConstOp<Npp32f> op(nConstant, eComparisonOperation);
    return CompareOperationExecutor<Npp32f, 1, CompareConstOp<Npp32f>>::execute(
        pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx.hStream, op);
}
...
NppStatus nppiCompareC_8u_C1R_Ctx(const Npp8u *pSrc, int nSrcStep, 
                                   ...
                                   NppiSize oSizeROI, NppCmpOp eComparisonOperation, 
                                   NppStreamContext nppStreamCtx) {
    NppStatus status = validateCompareCInputs(pSrc, nSrcStep, pDst, nDstStep, 
                                             oSizeROI, eComparisonOperation);
    if (status != NPP_SUCCESS) {
        return status;
    }

    return nppiCompareC_8u_C1R_Ctx_impl(pSrc, nSrcStep, nConstant, pDst, nDstStep, 
                                        oSizeROI, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiCompareC_8u_C1R(const Npp8u *pSrc, int nSrcStep, 
    ...
    return nppiCompareC_8u_C1R_Ctx(pSrc, nSrcStep, nConstant, pDst, nDstStep, 
                                   oSizeROI, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiCompareC_16s_C1R_Ctx(const Npp16s *pSrc, int nSrcStep, 
    ...
    return nppiCompareC_16s_C1R_Ctx_impl(pSrc, nSrcStep, nConstant, pDst, nDstStep, 
                                         oSizeROI, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiCompareC_16s_C1R(const Npp16s *pSrc, int nSrcStep, 
    ...
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiCompareC_16s_C1R_Ctx(pSrc, nSrcStep, nConstant, pDst, nDstStep, 
                                    oSizeROI, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiCompareC_32f_C1R_Ctx(const Npp32f *pSrc, int nSrcStep, 
    ...
    return nppiCompareC_32f_C1R_Ctx_impl(pSrc, nSrcStep, nConstant, pDst, nDstStep, 
                                         oSizeROI, eComparisonOperation, nppStreamCtx);
}
...
NppStatus nppiCompareC_32f_C1R(const Npp32f *pSrc, int nSrcStep, 
    ...
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiCompareC_32f_C1R_Ctx(pSrc, nSrcStep, nConstant, pDst, nDstStep, 
                                    oSizeROI, eComparisonOperation, nppStreamCtx);
}