...
__global__ void nppiAdd_8u_C1RSfs_kernel(
...
__global__ void nppiAdd_8u_C3RSfs_kernel(
    const Npp8u* pSrc1, int nSrc1Step,
    const Npp8u* pSrc2, int nSrc2Step,
    Npp8u* pDst, int nDstStep,
    int width, int height, int nScaleFactor)
...
__global__ void nppiAdd_8u_C4RSfs_kernel(
    const Npp8u* pSrc1, int nSrc1Step,
    const Npp8u* pSrc2, int nSrc2Step,
    Npp8u* pDst, int nDstStep,
    int width, int height, int nScaleFactor)
...
__global__ void nppiAdd_16u_C1RSfs_kernel(
...
__global__ void nppiAdd_16s_C1RSfs_kernel(
...
__global__ void nppiAdd_32f_C1R_kernel(
...
__global__ void nppiAdd_32f_C3R_kernel(
    const Npp32f* pSrc1, int nSrc1Step,
    const Npp32f* pSrc2, int nSrc2Step,
    Npp32f* pDst, int nDstStep,
    int width, int height)
    ...
    NppStreamContext nppStreamCtx)
{
    ...
    nppiAdd_32f_C1R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep,
    ...
    NppStreamContext nppStreamCtx)
{
    ...
    nppiAdd_32f_C3R_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep,
        oSizeROI.width, oSizeROI.height);
