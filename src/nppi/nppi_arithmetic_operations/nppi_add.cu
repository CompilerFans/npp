...
// Template instantiations for Add operation
IMPLEMENT_BINARY_OP_IMPL(Add, AddOp, 8u, 1, Sfs)
IMPLEMENT_BINARY_OP_IMPL(Add, AddOp, 8u, 3, Sfs)
IMPLEMENT_BINARY_OP_IMPL_NO_SCALE(Add, AddOp, 32f, 1)
IMPLEMENT_BINARY_OP_IMPL_NO_SCALE(Add, AddOp, 32f, 3)

// Public API functions using unified framework
IMPLEMENT_BINARY_OP_API(Add, 8u, 1, Sfs, true)
IMPLEMENT_BINARY_OP_API(Add, 8u, 3, Sfs, true) 
IMPLEMENT_BINARY_OP_API_NO_SCALE(Add, 32f, 1)
IMPLEMENT_BINARY_OP_API_NO_SCALE(Add, 32f, 3)
