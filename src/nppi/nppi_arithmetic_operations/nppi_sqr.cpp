 ...
 */
NppStatus nppiSqr_8u_C1RSfs_Ctx(const Npp8u* pSrc, int nSrcStep, Npp8u* pDst, int nDstStep,
                                 NppiSize oSizeROI, int nScaleFactor, NppStreamContext nppStreamCtx) {
...
NppStatus nppiSqr_8u_C1RSfs(const Npp8u* pSrc, int nSrcStep, Npp8u* pDst, int nDstStep,
 ...
 */
NppStatus nppiSqr_16u_C1RSfs_Ctx(const Npp16u* pSrc, int nSrcStep, Npp16u* pDst, int nDstStep,
                                  NppiSize oSizeROI, int nScaleFactor, NppStreamContext nppStreamCtx) {
    NppStatus status = validateSqrInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
...
NppStatus nppiSqr_16u_C1RSfs(const Npp16u* pSrc, int nSrcStep, Npp16u* pDst, int nDstStep,
                              NppiSize oSizeROI, int nScaleFactor) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
 ...
 */
NppStatus nppiSqr_16s_C1RSfs_Ctx(const Npp16s* pSrc, int nSrcStep, Npp16s* pDst, int nDstStep,
                                  NppiSize oSizeROI, int nScaleFactor, NppStreamContext nppStreamCtx) {
    NppStatus status = validateSqrInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
...
NppStatus nppiSqr_16s_C1RSfs(const Npp16s* pSrc, int nSrcStep, Npp16s* pDst, int nDstStep,
                              NppiSize oSizeROI, int nScaleFactor) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
 ...
 */
NppStatus nppiSqr_32f_C1R_Ctx(const Npp32f* pSrc, int nSrcStep, Npp32f* pDst, int nDstStep,
                               NppiSize oSizeROI, NppStreamContext nppStreamCtx) {
    NppStatus status = validateSqrInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
