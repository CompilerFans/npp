                                ...
                                NppStreamContext nppStreamCtx)
{
    ...
    return nppiDiv_8u_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    return nppiDiv_8u_C1RSfs_Ctx(pSrcDst, nSrcDstStep, pSrc, nSrcStep, 
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiDiv_16u_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiDiv_16s_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                             ...
                             NppiSize oSizeROI, int nScaleFactor)
{
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiDiv_16s_C1RSfs_Ctx(pSrc1, nSrc1Step, pSrc2, nSrc2Step, 
                                  pDst, nDstStep, oSizeROI, nScaleFactor, 
                                  nppStreamCtx);
}
                              ...
                              NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiDiv_32f_C1R_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
...
NppStatus nppiDiv_32f_C1IR_Ctx(const Npp32f * pSrc, int nSrcStep, 
                               ...
                               NppStreamContext nppStreamCtx)
{
    return nppiDiv_32f_C1R_Ctx(pSrcDst, nSrcDstStep, pSrc, nSrcStep, 
                           ...
                           NppiSize oSizeROI)
{
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiDiv_32f_C1IR_Ctx(pSrc, nSrcStep, pSrcDst, nSrcDstStep, 
                                oSizeROI, nppStreamCtx);
}
                                ...
                                NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiDiv_8u_C3RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                              ...
                              NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiDiv_32f_C3R_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nppStreamCtx);
}
