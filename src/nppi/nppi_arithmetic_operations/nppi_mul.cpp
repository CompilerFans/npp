...
extern "C" {
// 8-bit unsigned
NppStatus nppiMul_8u_C1RSfs_Ctx_cuda(
...
NppStatus nppiMul_8u_C3RSfs_Ctx_cuda(
    const Npp8u* pSrc1, int nSrc1Step, const Npp8u* pSrc2, int nSrc2Step,
    Npp8u* pDst, int nDstStep, NppiSize oSizeROI, int nScaleFactor,
    NppStreamContext nppStreamCtx);

// 16-bit unsigned
NppStatus nppiMul_16u_C1RSfs_Ctx_cuda(
...
// 16-bit signed
NppStatus nppiMul_16s_C1RSfs_Ctx_cuda(
 ...
 */
static NppStatus validateDualSourceParameters(
    const void* pSrc1, int nSrc1Step, const void* pSrc2, int nSrc2Step,
...
{
    // Validate parameters
    NppStatus status = validateDualSourceParameters(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, sizeof(Npp8u));
    ...
    return nppiMul_8u_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    return nppiMul_8u_C1RSfs_Ctx(pSrcDst, nSrcDstStep, pSrc, nSrcStep, 
                                 pSrcDst, nSrcDstStep, oSizeROI, nScaleFactor, 
                                 nppStreamCtx);
}
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiMul_16u_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                                 ...
                                 NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiMul_16s_C1RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                             ...
                             NppiSize oSizeROI, int nScaleFactor)
{
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiMul_16s_C1RSfs_Ctx(pSrc1, nSrc1Step, pSrc2, nSrc2Step, 
                                  pDst, nDstStep, oSizeROI, nScaleFactor, 
                                  nppStreamCtx);
}
                              ...
                              NppStreamContext nppStreamCtx)
{
    ...
    NppStatus status = validateDualSourceParameters(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, sizeof(Npp32f));
    if (status != NPP_NO_ERROR) {
        return status;
    }
    
    // Call CUDA implementation
    return nppiMul_32f_C1R_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
...
NppStatus nppiMul_32f_C1IR_Ctx(const Npp32f * pSrc, int nSrcStep, 
                               ...
                               NppStreamContext nppStreamCtx)
{
    return nppiMul_32f_C1R_Ctx(pSrcDst, nSrcDstStep, pSrc, nSrcStep, 
                           ...
                           NppiSize oSizeROI)
{
    NppStreamContext nppStreamCtx;
    nppGetStreamContext(&nppStreamCtx);
    return nppiMul_32f_C1IR_Ctx(pSrc, nSrcStep, pSrcDst, nSrcDstStep, 
                                oSizeROI, nppStreamCtx);
}
                                ...
                                NppStreamContext nppStreamCtx)
{
    ...
    // Call CUDA implementation
    return nppiMul_8u_C3RSfs_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nScaleFactor, nppStreamCtx);
}
                              ...
                              NppStreamContext nppStreamCtx)
{
    ...
    NppStatus status = validateDualSourceParameters(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, 3 * sizeof(Npp32f));
    if (status != NPP_NO_ERROR) {
        return status;
    }
    
    // Call CUDA implementation
    return nppiMul_32f_C3R_Ctx_cuda(
        pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, 
        oSizeROI, nppStreamCtx);
}
