...
NppStatus nppiAbsDiff_8u_C3R_Ctx_cuda(const Npp8u* pSrc1, int nSrc1Step, const Npp8u* pSrc2, int nSrc2Step,
                                      Npp8u* pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
NppStatus nppiAbsDiff_16s_C1R_Ctx_cuda(const Npp16s* pSrc1, int nSrc1Step, const Npp16s* pSrc2, int nSrc2Step,
...
// 16-bit signed single channel absolute difference
NppStatus nppiAbsDiff_16s_C1R_Ctx(const Npp16s* pSrc1, int nSrc1Step,
    ...
    return nppiAbsDiff_16s_C1R_Ctx_cuda(pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, oSizeROI, nppStreamCtx);
}

NppStatus nppiAbsDiff_16s_C1R(const Npp16s* pSrc1, int nSrc1Step,
                             const Npp16s* pSrc2, int nSrc2Step,
                             Npp16s* pDst, int nDstStep,
                             NppiSize oSizeROI) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiAbsDiff_16s_C1R_Ctx(pSrc1, nSrc1Step, pSrc2, nSrc2Step, pDst, nDstStep, oSizeROI, nppStreamCtx);
}
