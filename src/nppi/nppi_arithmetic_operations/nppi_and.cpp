...
extern "C" {
    cudaError_t nppiAnd_8u_C1R_kernel(const Npp8u* pSrc1, int nSrc1Step,
                                      const Npp8u* pSrc2, int nSrc2Step,
                                      Npp8u* pDst, int nDstStep,
                                      NppiSize oSizeROI, cudaStream_t stream);
    cudaError_t nppiAndC_8u_C1R_kernel(const Npp8u* pSrc, int nSrcStep,
...
NppStatus nppiAnd_8u_C1R_Ctx(const Npp8u * pSrc1, int nSrc1Step, 
    ...
    // 调用CUDA内核
    cudaError_t cudaStatus = nppiAnd_8u_C1R_kernel(pSrc1, nSrc1Step, pSrc2, nSrc2Step,
...
NppStatus nppiAndC_8u_C1R_Ctx(const Npp8u * pSrc, int nSrcStep, 
    ...
    // 调用CUDA内核
    cudaError_t cudaStatus = nppiAndC_8u_C1R_kernel(pSrc, nSrcStep, nConstant,
                                                    pDst, nDstStep, oSizeROI,
                                                    nppStreamCtx.hStream);
...
NppStatus nppiAndC_8u_C1R(const Npp8u * pSrc, int nSrcStep, 
    ...
    NppStreamContext ctx;
    ctx.hStream = 0;  // 默认流
    return nppiAndC_8u_C1R_Ctx(pSrc, nSrcStep, nConstant,
                               pDst, nDstStep, oSizeROI, ctx);
}