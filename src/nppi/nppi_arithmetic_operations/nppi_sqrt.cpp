 ...
 */
static inline NppStatus validateSqrtInputs(const void* pSrc, int nSrcStep, void* pDst, int nDstStep, NppiSize oSizeROI) {
 ...
 */
NppStatus nppiSqrt_8u_C1RSfs_Ctx(const Npp8u* pSrc, int nSrcStep, Npp8u* pDst, int nDstStep,
                                  NppiSize oSizeROI, int nScaleFactor, NppStreamContext nppStreamCtx) {
...
NppStatus nppiSqrt_8u_C1RSfs(const Npp8u* pSrc, int nSrcStep, Npp8u* pDst, int nDstStep,
 ...
 */
NppStatus nppiSqrt_16u_C1RSfs_Ctx(const Npp16u* pSrc, int nSrcStep, Npp16u* pDst, int nDstStep,
                                   NppiSize oSizeROI, int nScaleFactor, NppStreamContext nppStreamCtx) {
    NppStatus status = validateSqrtInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
...
NppStatus nppiSqrt_16u_C1RSfs(const Npp16u* pSrc, int nSrcStep, Npp16u* pDst, int nDstStep,
                               NppiSize oSizeROI, int nScaleFactor) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
 ...
 */
NppStatus nppiSqrt_16s_C1RSfs_Ctx(const Npp16s* pSrc, int nSrcStep, Npp16s* pDst, int nDstStep,
                                   NppiSize oSizeROI, int nScaleFactor, NppStreamContext nppStreamCtx) {
    NppStatus status = validateSqrtInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
...
NppStatus nppiSqrt_16s_C1RSfs(const Npp16s* pSrc, int nSrcStep, Npp16s* pDst, int nDstStep,
                               NppiSize oSizeROI, int nScaleFactor) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
 ...
 */
NppStatus nppiSqrt_32f_C1R_Ctx(const Npp32f* pSrc, int nSrcStep, Npp32f* pDst, int nDstStep,
                                NppiSize oSizeROI, NppStreamContext nppStreamCtx) {
    NppStatus status = validateSqrtInputs(pSrc, nSrcStep, pDst, nDstStep, oSizeROI);
    if (status != NPP_SUCCESS) {
        return status;
...
NppStatus nppiSqrt_32f_C1R(const Npp32f* pSrc, int nSrcStep, Npp32f* pDst, int nDstStep, NppiSize oSizeROI) {
    NppStreamContext nppStreamCtx;
    nppStreamCtx.hStream = 0;
    return nppiSqrt_32f_C1R_Ctx(pSrc, nSrcStep, pDst, nDstStep, oSizeROI, nppStreamCtx);
}