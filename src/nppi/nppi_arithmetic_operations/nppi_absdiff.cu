...
__global__ void nppiAbsDiff_8u_C1R_kernel(const Npp8u* pSrc1, int nSrc1Step,
...
__global__ void nppiAbsDiff_8u_C3R_kernel(const Npp8u* pSrc1, int nSrc1Step,
                                          const Npp8u* pSrc2, int nSrc2Step,
                                          Npp8u* pDst, int nDstStep,
                                          int width, int height) {
    int x = blockIdx.x * blockDim.x + threadIdx.x;
...
NppStatus nppiAbsDiff_8u_C1R_Ctx_cuda(const Npp8u* pSrc1, int nSrc1Step,
                                      const Npp8u* pSrc2, int nSrc2Step,
                                      Npp8u* pDst, int nDstStep,
...
NppStatus nppiAbsDiff_8u_C3R_Ctx_cuda(const Npp8u* pSrc1, int nSrc1Step,
                                      const Npp8u* pSrc2, int nSrc2Step,
                                      Npp8u* pDst, int nDstStep,
                                      NppiSize oSizeROI, NppStreamContext nppStreamCtx) {
    dim3 blockSize(16, 16);
