 ...
 */
static inline NppStatus validateConvertInputs(const void* pSrc, int nSrcStep,
...
NppStatus nppiConvert_8u32f_C1R_Ctx(const Npp8u* pSrc, int nSrcStep, 
    ...
    return nppiConvert_8u32f_C1R_Ctx_cuda(pSrc, nSrcStep, pDst, nDstStep, 
 ...
 */
NppStatus nppiConvert_8u32f_C1R(const Npp8u* pSrc, int nSrcStep, 
                               Npp32f* pDst, int nDstStep, NppiSize oSizeROI) {
