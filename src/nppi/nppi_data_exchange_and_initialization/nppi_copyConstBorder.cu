...
__global__ void nppiCopyConstBorder_8u_C1R_kernel(const Npp8u *pSrc, int nSrcStep, int srcWidth, int srcHeight,
                                                  Npp8u *pDst, int nDstStep, int dstWidth, int dstHeight,
...
__global__ void nppiCopyConstBorder_8u_C1R_optimized_kernel(const Npp8u *pSrc, int nSrcStep, int srcWidth,
                                                            int srcHeight, Npp8u *pDst, int nDstStep, int dstWidth,
                                                            int dstHeight, int nTopBorderHeight, int nLeftBorderWidth,
                                                            Npp8u nValue) {
  int x = blockIdx.x * blockDim.x + threadIdx.x;
  int y = blockIdx.y * blockDim.y + threadIdx.y;
...
NppStatus nppiCopyConstBorder_8u_C1R_Ctx_impl(const Npp8u *pSrc, int nSrcStep, NppiSize oSrcSizeROI, Npp8u *pDst,
  ...
  nppiCopyConstBorder_8u_C1R_optimized_kernel<<<gridSize, blockSize, 0, nppStreamCtx.hStream>>>(
      pSrc, nSrcStep, oSrcSizeROI.width, oSrcSizeROI.height, pDst, nDstStep, oDstSizeROI.width, oDstSizeROI.height,
