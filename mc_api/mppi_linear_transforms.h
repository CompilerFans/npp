  ...
  * Users Notice. 
  */ 
#ifndef MC_MPPI_LINEAR_TRANSFORMS_H
#define MC_MPPI_LINEAR_TRANSFORMS_H
 
/**
 * \file mppi_linear_transforms.h
 ...
 */
MppStatus
mppiMagnitude_32fc32f_C1R_Ctx(const Mpp32fc * pSrc, int nSrcStep,
 ...
 */                                       
MppStatus
mppiMagnitude_32fc32f_C1R(const Mpp32fc * pSrc, int nSrcStep,
                                Mpp32f  * pDst, int nDstStep,
                          MppiSize oSizeROI);
 ...
 * for sorting/comparing only, using this function instead of mppiMagnitude_32fc32f_C1R
 ...
 */
MppStatus
mppiMagnitudeSqr_32fc32f_C1R_Ctx(const Mpp32fc * pSrc, int nSrcStep,
                                       Mpp32f  * pDst, int nDstStep,
                                 MppiSize oSizeROI, MppStreamContext mppStreamCtx);
/**
 * 32-bit floating point complex to 32-bit floating point squared magnitude.
 ...
 */                                      
MppStatus
mppiMagnitudeSqr_32fc32f_C1R(const Mpp32fc * pSrc, int nSrcStep,
                                   Mpp32f  * pDst, int nDstStep,
                             MppiSize oSizeROI);
...
#endif /* MC_MPPI_LINEAR_TRANSFORMS_H */
