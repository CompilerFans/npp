  ...
  * Users Notice. 
  */ 
#ifndef MC_MPPI_SUPPORT_FUNCTIONS_H
#define MC_MPPI_SUPPORT_FUNCTIONS_H
 
/**
 * \file mppi_support_functions.h
 ...
 * for any of the MPP image-processing primitives to work correctly, its absense may
 ...
 * beneficial for performance. It is not mandatory to use these allocators. Any valid MACA device-memory
 * pointers can be used by the MPP primitives and there are no restrictions on line strides.
 *
 * @{
 *
 */
 ...
 */
Mpp8u  * 
mppiMalloc_8u_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp8u  * 
mppiMalloc_8u_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp8u  * 
mppiMalloc_8u_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp8u  * 
mppiMalloc_8u_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16u * 
mppiMalloc_16u_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16u * 
mppiMalloc_16u_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16u * 
mppiMalloc_16u_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16u * 
mppiMalloc_16u_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16s * 
mppiMalloc_16s_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16s * 
mppiMalloc_16s_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16s * 
mppiMalloc_16s_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16sc * 
mppiMalloc_16sc_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16sc * 
mppiMalloc_16sc_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16sc * 
mppiMalloc_16sc_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp16sc * 
mppiMalloc_16sc_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32s * 
mppiMalloc_32s_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32s * 
mppiMalloc_32s_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32s * 
mppiMalloc_32s_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32sc * 
mppiMalloc_32sc_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32sc * 
mppiMalloc_32sc_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32sc * 
mppiMalloc_32sc_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32sc * 
mppiMalloc_32sc_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32f * 
mppiMalloc_32f_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32f * 
mppiMalloc_32f_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32f * 
mppiMalloc_32f_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32f * 
mppiMalloc_32f_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32fc * 
mppiMalloc_32fc_C1(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32fc * 
mppiMalloc_32fc_C2(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32fc * 
mppiMalloc_32fc_C3(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 */
Mpp32fc * 
mppiMalloc_32fc_C4(int nWidthPixels, int nHeightPixels, int * pStepBytes);
 ...
 * This method should be used to free memory allocated with any of the mppiMalloc_<modifier> methods.
 * \param pData A pointer to memory allocated using mppiMalloc_<modifier>.
 */
void 
mppiFree(void * pData);
...
#endif /* MC_MPPI_SUPPORT_FUNCTIONS_H */
